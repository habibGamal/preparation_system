...
final class RawMaterialOutService
{
    public function close(RawMaterialOut $out): void
    {
    ...
    public function clone(RawMaterialOut $out): RawMaterialOut
    {
        return DB::transaction(function () use ($out): RawMaterialOut {
            $clonedOut = RawMaterialOut::create([
                'user_id' => auth()->id(),
