...
namespace App\Filament\Resources\RawMaterialEntranceResource\Schemas;
...
final class RawMaterialEntranceForm
{
                ...
                Section::make('معلومات الإدخال')
                    ->schema([
                        ...
                        Select::make('supplier_id')
                            ...
                            ->disabled(
                                fn (string $operation, ?RawMaterialEntrance $record) => $operation === 'edit' && $record?->status === MaterialEntranceStatus::Closed
                            ),
                        ...
                        Placeholder::make('status_display')
                            ->label('الحالة')
                            ->content(fn (?RawMaterialEntrance $record) => $record?->status?->getLabel() ?? MaterialEntranceStatus::Draft->getLabel()),

                        Placeholder::make('closed_at_display')
                            ->label('تاريخ الإغلاق')
                            ->content(fn (?RawMaterialEntrance $record) => $record?->closed_at?->format('Y-m-d H:i') ?? '-')
                            ->visible(fn (?RawMaterialEntrance $record) => $record?->status === MaterialEntranceStatus::Closed),
